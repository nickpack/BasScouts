# Django settings for BasScouts project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'scouts.sqlite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'f^s_q5sz*16dhjg8vf0mysl=ztk+ct5svrx=ypj)cmv@y#m2xf'
...
ROOT_URLCONF = 'basscouts.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'basscouts.wsgi.application'
